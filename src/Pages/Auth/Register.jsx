...
export const Register =() => {
    ...
    <>
     ...
     <form className = "grid grid-cols-[30%_70%] grid-rows-7 w-4/5 gap-2 md:gap-4 2xl:gap-10 h-4/6 2xl:mt-24 mt-16">
                                <h3 className = " text-start 2xl:text-[3rem] text-[1.5rem] font-[400] col-start-2 row-start-1 row-span-2 ">Đăng ký</h3>
