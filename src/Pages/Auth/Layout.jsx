    ...
    return  (
        ...
        <div className = "relative z-1 flex justify-between max-w-screen  h-screen bg-[#f6f6f6] ">
                <div className = "relative z-2  hidden md:flex md:flex-col md:justify-center md:m-[1rem] md:items-center md:w-[40%] md:h-[100%] ">
                        ...
                        <div className = "absolute z-2 top-0 right-56 glow-background rounded-full"></div>
                </div>
                <div className = "absolute z-3 2xl:top-28 2xl:left-28 top-10 left-24 hidden md:flex md:flex-col md:justify-center md:m-[1rem] md:w-[40%]  ">
